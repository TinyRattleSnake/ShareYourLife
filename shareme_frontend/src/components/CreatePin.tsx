...
const CreatePin = (props: { user: any }) => {
            ...
            <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
                <div className='bg-secondaryColor p-3 flex flex-0.7 w-full'>
                    <div className='flex justify-center items-center flex-col border-dotted border-gray-300 p-3 w-full h-420'>
                        {loading && <Spinner message="we are loading!" />}
                        ...
                        <div>
                            ...
                            >
                                ...
                                {categories.map((category, index) => (
                                    <option className='text-base border-0 outline-none capitalize bg-white text-black' value={category.name} key={index}>
                                        {category.name}
                                    </option>
                                ))}
                            </select>
